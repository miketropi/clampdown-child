...
if( function_exists('acf_add_local_field_group') ):
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			...
			array(
				'key' => 'field_6296d8baf25bf',
				'label' => 'Attachment By Order Status',
				'name' => 'attachment_by_order_status',
				'type' => 'repeater',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
				...
				'sub_fields' => array(
					...
					array(
						...
						'choices' => array(
							'wc-invoice_1' => 'Invoice 1',
							'wc-deposit_paid' => 'Deposit Paid',
							'wc-make_tests' => 'Make Tests',
							'wc-ship_tests' => 'Ship Tests',
							'wc-tests_approval' => 'Tests Approval',
							'wc-art_approval' => 'Art Approval',
							'wc-press' => 'Press',
							'wc-assemble' => 'Assemble',
							'wc-invoice_2' => 'Invoice 2',
							'wc-completed_shipp' => 'Completed / Shipped',
							...
							'wc-failed' => 'Failed',
							'wc-ywraq-new' => 'New Quote Request',
							'wc-ywraq-pending' => 'Pending Quote',
							'wc-ywraq-expired' => 'Expired Quote',
							'wc-ywraq-accepted' => 'Accepted Quote',
							'wc-ywraq-rejected' => 'Rejected Quote',
						),
						'default_value' => false,
						'allow_null' => 0,
						'multiple' => 0,
