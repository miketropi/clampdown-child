...
<div class="table-wrapper">
	<div class="mark"></div>
	<table class="quote-table __order-info-table" cellspacing="0" cellpadding="6" style="width: 100%;" border="0">
		<thead>
		<tr style="background: black;">
			...
			<?php if ( in_array( 'all', $columns, true ) || in_array( 'product_name', $columns, true ) ) : ?>
				...
				<th scope="col" colspan="<?php echo esc_attr( $colspan_title ); ?>" style="text-align:left; color: white;">
			...
			<?php if ( in_array( 'all', $columns, true ) || in_array( 'product_subtotal', $columns, true ) ) : ?>
				<th scope="col" class="last-col" style="text-align:right;">
		...
		if ( ! empty( $items ) ) :
			foreach ( $items as $index => $item ) :
              ...
              <?php 
              /**
               * request_quote_pdf_after_title hook.
               * 
               */
              do_action('request_quote_pdf_after_title', $_product->get_id(), $order_id); 
              ?>
						</td>
					<?php endif ?>
					<?php if ( in_array( 'all', $columns, true ) || in_array( 'unit_price', $columns, true ) ) : ?>
        ...
        <?php 
        /**
         * @see clampdown_child_woo_raq_pdf_info_pricing - 20
         */
        do_action('request_quote_pdf_after_tr_item', $_product->get_id(), $order_id); 
        ?>
				<?php
			endforeach;
			?>
