...
<div class="ywraq-view-quote-wrapper ywraq-status-<?php echo esc_attr( $order->get_status() ); ?>">
	...
	<p>
		<a 
      class="back-url-style"
      href="<?php echo esc_url( YITH_YWRAQ_Frontend()->my_account->get_quotes_url() ); ?>" >
      <span class="__icon"><?php echo clampdown_svg('back_arrow'); ?></span>
      <?php esc_html_e( 'Back to quote list', 'yith-woocommerce-request-a-quote' ); ?>
    </a>
	</p>
